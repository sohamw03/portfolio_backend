...
<body>
  <div class="main" style="background-color: #10151d; font-family: Arial, sans-serif; padding: 7rem 1rem; border-radius: 15px;">
    <h1 style="font-weight: 400; font-size: 2.125rem; line-height: 1.235; letter-spacing: 0.00735em; color: #bfc7d2; text-align: center; margin-bottom: 3rem; margin-top: 0;">Portfolio Mailing System</h1>
